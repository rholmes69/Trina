...
# Settings are read per-call (not cached at import) so profile switches take effect immediately.
...
def _elevenlabs_audio(text: str) -> bytes:
    try:
        ...
        raise RuntimeError("ElevenLabs provider requires: pip install elevenlabs")
...
def generate_audio(text: str) -> bytes:
    ...
    if os.getenv("TTS_PROVIDER", "gemini") == "elevenlabs":
